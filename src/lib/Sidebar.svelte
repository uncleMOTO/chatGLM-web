...
<aside class="menu">
  <p class="menu-label">邮件</p>
  <ul class="menu-list">
    {#if sortedChats.length === 0}
      <li><a href={'#'} class="is-disabled">新的邮件</a></li>
    {:else}
      <li>
        <ul>
  ...
  <ul class="menu-list">
    ...
    <li>
      <a href={'#/chat/new'} class="panel-block" class:is-disabled={!$apiKeyStorage}
        ><span class="greyscale mr-2">➕</span> 新邮件</a
      >
    </li>
    <li>
      <a class="panel-block"
        ...
        }}><span class="greyscale mr-2">🗑️</span> 清除邮件</a
      >
    </li>
    {#if activeChatId}
      <li>
        <a
          ...
          }}><span class="greyscale mr-2">📥</span>导出邮件</a
        >
      </li>
    {/if}
  </ul>
